...
public interface PlatformEnvironmentApi {
  ...
  @ApiOperation(value = "", notes = "Creates a new PlatformEnvironment ", response = PlatformEnvironment.class, tags = {
      "platform",})
  @ApiResponses(value = {
  ...
  ResponseEntity<PlatformEnvironment> addPlatformEnvironment(
      @ApiParam(value = "PlatformEnvironment to be created ", required = true) @Valid @RequestBody PlatformEnvironment platformEnvironment);


  @ApiOperation(value = "", notes = "Returns the PlatformEnvironment identified by the id parameter. ", response = PlatformEnvironment.class, tags = {
      "platform",})
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "OK", response = PlatformEnvironment.class),
      @ApiResponse(code = 400, message = "Bad Request", response = Error.class),
  ...
  ResponseEntity<PlatformEnvironment> findPlatformEnvironment(
      @ApiParam(value = "Unique identifier of the resource", required = true) @PathVariable("id") String id);


  @ApiOperation(value = "", notes = "Returns all platform environment  visible to the user ", response = PlatformEnvironment.class, responseContainer = "List", tags = {
      "platform",})
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "OK ", response = PlatformEnvironment.class),
      @ApiResponse(code = 400, message = "Bad Request", response = Error.class),

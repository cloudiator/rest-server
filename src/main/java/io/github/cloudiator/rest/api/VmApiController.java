...
public class VmApiController implements VmApi {
    ...
    public ResponseEntity<Task> addVM(@ApiParam(value = "VirtualMachine Request", required = true) @Valid @RequestBody VirtualMachineRequest virtualMachineRequest) throws Exception {
        // do some magic!

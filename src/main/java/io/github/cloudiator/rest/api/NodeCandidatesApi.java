...
public interface NodeCandidatesApi {
  ...
  @ApiOperation(value = "", nickname = "findNodeCandidates", notes = "Returns possible node candidates. ", response = NodeCandidate.class, responseContainer = "List", tags = {
      "cloud",})
  @ApiResponses(value = {
  ...
  ResponseEntity<List<NodeCandidate>> findNodeCandidates(

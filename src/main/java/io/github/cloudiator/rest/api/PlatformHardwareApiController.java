...
public class PlatformHardwareApiController implements PlatformHardwareApi {
  ...
  public ResponseEntity<PlatformHardware> addPlatformHardware(
      @ApiParam(value = "PlatformHardware to be created ", required = true) @Valid @RequestBody NewPlatformHardware platformHardware) {
    String accept = request.getHeader("Accept");
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<PlatformHardware>(
            objectMapper.readValue("\"\"", PlatformHardware.class), HttpStatus.NOT_IMPLEMENTED);
      } catch (IOException e) {
  ...
  public ResponseEntity<PlatformHardware> findPlatformHardware(
  ...
  public ResponseEntity<List<PlatformHardware>> findPlatformHardwares() {
    ...
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<List<PlatformHardware>>(

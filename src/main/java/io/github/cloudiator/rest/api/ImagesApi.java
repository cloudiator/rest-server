...
public interface ImagesApi {
  ...
  @ApiOperation(value = "", notes = "Updates a specific image ", response = Image.class, tags = {
      "cloud",})
  @ApiResponses(value = {
  ...
  ResponseEntity<Image> editImage(
      @ApiParam(value = "Unique identifier of the resource", required = true) @PathVariable("id") String id,
      @ApiParam(value = "Image to update ", required = true) @Valid @RequestBody Image image);


  @ApiOperation(value = "", notes = "Returns all images visable to the user ", response = Image.class, responseContainer = "List", tags = {
      "cloud",})
  @ApiResponses(value = {

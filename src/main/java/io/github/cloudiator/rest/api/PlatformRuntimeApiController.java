...
public class PlatformRuntimeApiController implements PlatformRuntimeApi {
  ...
  public ResponseEntity<PlatformRuntime> addPlatformRuntime(
      @ApiParam(value = "PlatformRuntime to be created ", required = true) @Valid @RequestBody NewPlatformRuntime platformRuntime) {
    String accept = request.getHeader("Accept");
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<PlatformRuntime>(
            objectMapper.readValue("\"\"", PlatformRuntime.class), HttpStatus.NOT_IMPLEMENTED);
      } catch (IOException e) {
  ...
  public ResponseEntity<PlatformRuntime> findPlatformRuntime(
  ...
  public ResponseEntity<List<PlatformRuntime>> findPlatformRuntimes() {
    ...
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<List<PlatformRuntime>>(

...
public interface NodeApi {
    ...
    @ApiOperation(value = "", notes = "Create a new node request", response = LongRunningRequest.class, tags={ "node", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<LongRunningRequest> addNode(@ApiParam(value = "Node Request" ,required=true )  @Valid @RequestBody NodeRequest nodeRequest);

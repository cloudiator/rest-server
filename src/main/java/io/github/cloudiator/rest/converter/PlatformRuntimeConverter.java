...
public class PlatformRuntimeConverter implements TwoWayConverter<PlatformRuntime, PaasEntities.Runtime> {
    ...
    private class RuntimeTypeConverter implements TwoWayConverter<PlatformRuntime.RuntimeTypeEnum, PaasEntities.RuntimeType> {
    ...
    private class RuntimeLanguageConverter implements TwoWayConverter<PlatformRuntime.LanguageEnum, PaasEntities.RuntimeLanguage> {

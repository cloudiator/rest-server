...
public class LRRMapServiceTest {
    ...
    public LRRMapServiceTest() {
        ...
        this.testlrr2 = new LongRunningRequest()
                ...
                .referenceId("32chars_long_testID_for_testlrr1").taskStatus(LRRStatus.RUNNING).taskType(LRRType.VIRTUALMACHINEREQUEST);
    ...
    public void getLRR() throws Exception {
        ...
        LongRunningRequest actual = lrrMapService.getLRR("DummyUser", "32chars_long_testID_for_testlrr1");
    ...
    public void changeLRRStatus() throws Exception {
        ...
        assertThat(lrrMapService.getLRR("DummyUser","32chars_long_testID_for_testlrr1").getTaskStatus(),is(LRRStatus.RUNNING));

        LongRunningRequest actual = lrrMapService.changeLRRStatus("DummyUser", "32chars_long_testID_for_testlrr1", LRRStatus.COMPLETED);

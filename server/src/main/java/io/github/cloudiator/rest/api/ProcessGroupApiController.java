...
public class ProcessGroupApiController implements ProcessGroupApi {
    ...
    public ResponseEntity<List<ProcessGroup>> findProcessGroups() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<ProcessGroup>>(objectMapper.readValue("[ {  \"processes\" : [ \"\", \"\" ],  \"id\" : \"id\"}, {  \"processes\" : [ \"\", \"\" ],  \"id\" : \"id\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<ProcessGroup> getProcessGroup(@ApiParam(value = "Unique identifier of the resource",required=true) @PathVariable("id") String id) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<ProcessGroup>(objectMapper.readValue("{  \"processes\" : [ \"\", \"\" ],  \"id\" : \"id\"}", ProcessGroup.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);

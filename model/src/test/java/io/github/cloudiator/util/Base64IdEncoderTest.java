...
public class Base64IdEncoderTest {
  ...
  @Test
  public void encode() {
    assertThat(TEST_ENCODE, is(CoreMatchers.equalTo(ENCODER.encode(TEST_ID))));
  }

  @Test
  public void decode() {
    assertThat(TEST_ID, is(CoreMatchers.equalTo(ENCODER.decode(TEST_ENCODE))));
  }

  @Test
  public void repeat() {
    String repeat = ENCODER.decode(ENCODER.encode(TEST_ID));
    MatcherAssert.assertThat(repeat, is(CoreMatchers.equalTo(TEST_ID)));
  }
}
